...
<body>
    <h5>머신 러닝(Machine Learning) 하위 분야인 딥 러닝(Deep Learning)의 이미지 분류 기술을 이용한 웹 대시보드 프로젝트입니다.</h5>
    <h5>사용자가 업로드한 음식 이미지 데이터에 대해 해당 모델이 학습한 11가지 종류 중 하나로 분류하는 기능을 구현하였습니다. </h5>
<br>
    <h6>■링크 : 링크 삽입 자리</h6>
<br>
<!--1번부터 해당 프로젝트에 맞게 일괄 갱신 필요-->
<!--목차 1. 머신러닝 간략 소개-->
    <h3>1. 개괄</h3>
  <ol start="1" type="a">
...
<!--목차 4. 개발환경 요약-->
  ...
  <ol start="1" type="a">
    ...
    <li>[코드 에디터] : Visual Studio Code, Google Colab
    <li>[AI학습 툴] : Teachable Machine</li>
    <li>[프레임워크] : Streamlit</li>
    <li>[주요 라이브러리] : numpy, pandas, scikit-learn, tensorflow, ipython, pillow, jupyter</li>
